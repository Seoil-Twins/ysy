...
class UserService extends Service {
  ...
  async selectForResponse(userId: number): Promise<ResponseUser> {
  ...
  async create(transaction: Transaction | null = null, data: CreateUser): Promise<User> {
  ...
  async update(transaction: Transaction | null = null, user: User, data: UpdateUser, file?: File): Promise<User> {
